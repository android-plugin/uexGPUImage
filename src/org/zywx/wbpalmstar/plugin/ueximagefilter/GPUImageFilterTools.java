...
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFValenciaFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFWaldenFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFXprollFilter;
        ...
        switch (type) {
            ...
            case TONE_CURVE:
                ...
                toneCurveFilter.setFromCurveFileInputStream(
                        context.getResources().openRawResource(EUExUtil.getResRawID("tone_cuver_sample")));
                return toneCurveFilter;
            case LOOKUP_AMATORKA:
                GPUImageLookupFilter amatorka = new GPUImageLookupFilter();
                amatorka.setBitmap(BitmapFactory.decodeResource(context.getResources(), EUExUtil.getResDrawableID("lookup_amatorka")));
                return amatorka;
