...
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IF1977Filter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFAmaroFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFBrannanFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFEarlybirdFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFHefeFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFHudsonFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFInkwellFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFLomoFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFLordKelvinFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFNashvilleFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFRiseFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFSierraFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFSutroFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFToasterFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.filter.IFWaldenFilter;
import org.zywx.wbpalmstar.plugin.ueximagefilter.vo.OpenViewVO;
 ...
 */
public class EUExImageFilter extends EUExBase {
    ...
    public EUExImageFilter(Context context, EBrowserView eBrowserView) {
    ...
    public void open(String[] params){
        ...
        Intent intent=new Intent(mContext, org.zywx.wbpalmstar.plugin.ueximagefilter.ImageFilterActivity.class);
        intent.putExtra(org.zywx.wbpalmstar.plugin.ueximagefilter.ImageFilterActivity.KEY_IMAGE_PATH, BUtility.getRealPathWithCopyRes(mBrwView,openViewVO.getPath()));
