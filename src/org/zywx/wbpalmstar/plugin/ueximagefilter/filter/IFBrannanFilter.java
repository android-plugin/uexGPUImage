...
public class IFBrannanFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(EUExUtil.getResDrawableID("brannan_process"));
        addInputTexture(EUExUtil.getResDrawableID("brannan_blowout"));
        addInputTexture(EUExUtil.getResDrawableID("brannan_contrast"));
        addInputTexture(EUExUtil.getResDrawableID("brannan_luma"));
        addInputTexture(EUExUtil.getResDrawableID("brannan_screen"));
    }
}
