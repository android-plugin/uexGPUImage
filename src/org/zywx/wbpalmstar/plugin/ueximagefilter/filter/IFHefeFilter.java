...
public class IFHefeFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(EUExUtil.getResDrawableID("edge_burn"));
        addInputTexture(EUExUtil.getResDrawableID("hefe_map"));
        addInputTexture(EUExUtil.getResDrawableID("hefe_gradient_map"));
        addInputTexture(EUExUtil.getResDrawableID("hefe_soft_light"));
        addInputTexture(EUExUtil.getResDrawableID("hefe_metal"));
    }
}
