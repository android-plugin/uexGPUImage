...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(EUExUtil.getResDrawableID("earlybird_curves"));
        addInputTexture(EUExUtil.getResDrawableID("earlybird_overlay_map"));
        addInputTexture(EUExUtil.getResDrawableID("vignette_map"));
        addInputTexture(EUExUtil.getResDrawableID("earlybird_blowout"));
        addInputTexture(EUExUtil.getResDrawableID("earlybird_map"));
    }
}
