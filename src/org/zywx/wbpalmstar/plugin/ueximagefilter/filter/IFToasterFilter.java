package org.zywx.wbpalmstar.plugin.ueximagefilter.filter;
...
public class IFToasterFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(EUExUtil.getResDrawableID("toaster_metal"));
        addInputTexture(EUExUtil.getResDrawableID("toaster_soft_light"));
        addInputTexture(EUExUtil.getResDrawableID("toaster_curves"));
        addInputTexture(EUExUtil.getResDrawableID("toaster_overlay_map_warm"));
        addInputTexture(EUExUtil.getResDrawableID("toaster_color_shift"));
    }
}
