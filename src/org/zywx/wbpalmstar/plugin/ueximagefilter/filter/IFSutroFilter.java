...
public class IFSutroFilter extends IFImageFilter {
    ...
    private void setRes() {
        ...
        addInputTexture(EUExUtil.getResDrawableID("sutro_metal"));
        addInputTexture(EUExUtil.getResDrawableID("soft_light"));
        addInputTexture(EUExUtil.getResDrawableID("sutro_edge_burn"));
        addInputTexture(EUExUtil.getResDrawableID("sutro_curves"));
    }
}
